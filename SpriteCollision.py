...
background_image = pygame.transform.scale(pygame.image.load("placeholder.png"), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
while running:
  ...
  if not won:
    ...
    x_change = (keys[pygame.K_LEFT] - keys[pygame.K_RIGHT]) * (MOVEMENT_SPEED * -1)
